...
namespace osu.Game.Rulesets.Mix.Objects
{
    internal class MixHitObjectDifficulty
    {
        ...
        private static double spacingWeight(double distance, MixDifficultyCalculator.DifficultyType type)
        {
            switch (type)
            {
                case MixDifficultyCalculator.DifficultyType.Speed:
                ...
                case MixDifficultyCalculator.DifficultyType.Aim:
