...
namespace osu.Core.Wiki.Included.Symcol
{
    public class SymcolWikiSet : WikiSet
    {
        ...
        public override Texture Icon => SymManager.SymTextures.Get("Symcol@2x");

        public override Texture HeaderBackground => SymManager.SymTextures.Get("Symcoltober 1440 2018");
