...
{
    [Serializable]
    public class SendingMapPacket : Packet, ISerializable
    {
        ...
        public SendingMapPacket(string map, long size)
        {
            MapName = map;
            Size = size;
        }

        public SendingMapPacket(SerializationInfo info, StreamingContext context)
        {
