...
namespace osu.Game.Rulesets.Classic.ClassicDifficulty.Preprocessing
{
    ...
    public class OsuDifficultyHitObject
    {
        ...
        /// </summary>
        public ClassicHitObject BaseObject { get; }
        ...
        private readonly ClassicHitObject[] t;

        /// <summary>
        /// Initializes the object calculating extra data required for difficulty calculation.
        /// </summary>
        public OsuDifficultyHitObject(ClassicHitObject[] triangle, double timeRate)
        {
        ...
        private void computeSliderCursorPosition(Slider slider)
        {
            ...
            var scoringTimes = slider.NestedHitObjects.Select(t => t.StartTime); foreach (var time in scoringTimes)
                computeVertex(time);
