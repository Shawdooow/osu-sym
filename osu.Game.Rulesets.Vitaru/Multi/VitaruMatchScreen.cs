...
namespace osu.Game.Rulesets.Vitaru.Multi
{
    ...
    {
        private readonly Bindable<PlayableCharacters> currentCharacter = VitaruSettings.VitaruConfigManager.GetBindable<PlayableCharacters>(VitaruSetting.Characters);
                ...
                if (value == MatchScreenMode.RulesetSettings)
                    MatchTools.SelectedContent.Child = new Container
                    {
                        ...
                        Children = new Drawable[]
                        {
                            ...
                            new MultiplayerDropdownEnumOption<PlayableCharacters>(currentCharacter, "Character", 2, false),
                        }
                    };
            };
        }
