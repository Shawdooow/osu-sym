...
namespace osu.Game.Rulesets.Vitaru.UI
{
    public class VitaruRulesetContainer : RulesetContainer<VitaruHitObject>
    {
        ...
        protected override void LoadComplete()
        {
            ...
            if (VitaruPlayfield.OnNewJudgement == null && !rankedFilter)
            {
        ...
        protected override void Update()
        {
            ...
            if (ranked.Bindable.Value >= 1000 && VitaruPlayfield.OnNewJudgement != null && rankedFilter)
            {
                OsuColour osu = new OsuColour();
                VitaruPlayfield.OnNewJudgement = null;
                ranked.SpriteText.Colour = osu.Yellow;
